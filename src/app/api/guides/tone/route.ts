...
import { CreateGuideTonePayload, CreateMnGuideResponse } from "@/shared/types/guides.types"
...
export async function POST(request: NextRequest) {
  try {
    ...
    const payload: CreateGuideTonePayload = await request.json()
    const uri = `${process.env.BACKEND_URI}/tone/create-guide`
