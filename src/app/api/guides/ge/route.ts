...
import { CreateGuidePkkPayload, CreateMnGuideResponse } from "@/shared/types/guides.types"
...
export async function POST(request: NextRequest) {
  try {
    ...
    const uri = `${process.env.BACKEND_URI}/ge/create-guide`
    ...
    console.log('res?.data route ge', res?.data)
