...
import { CREATE_GUIDE_STEPS, initialAliases, initialStateFormTone } from "@/shared/constants/guides.constants";
      ...
      <ModalBody>
        ...
        { step === 1 && (
          <AddAddressTone
            ...
            aliasSaved={aliases.current.origin}
        ...
        { step === 2 && (
          <AddAddressTone
            ...
            aliasSaved={aliases.current.destination}
